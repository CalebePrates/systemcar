...
SECRET_KEY = '@d$ldf_22wxbt6n^t*)0-gp(x%nvj0z27c)g*_%+2@@px-5*gt'
...
SUITE_TEMPLATES = ['../pages/']

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': SUITE_TEMPLATES + [],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = ( os.path.join('../suite/static/admin/'), os.path.join('static'))
